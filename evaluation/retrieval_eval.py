...
def create_retrieval_eval_graph() -> CompiledStateGraph:
    """
    创建 Retrieval 专用评测 Graph。
    ...
    Retrieval Evaluation 只回答一个问题：

        “在商品已经识别正确的前提下，
         Retriever 能不能找到正确的 chunk？”
    ...
    # 注意：
    #
    # 不再从 item_name_confirm 开始。
    #
    # evaluation_dataset 已经提供正确 item_name。
    # --------------------------------------------------------
