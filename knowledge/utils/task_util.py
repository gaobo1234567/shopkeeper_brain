...
def get_task_result(task_id: str, key: str, default: str = "") -> str:
    ...
    正常情况下所有节点都可以使用，但这里只是为了非流式调用时候使用，所以只用到了answer节点。
    """
